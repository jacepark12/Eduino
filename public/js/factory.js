...
/**
 * Variable for saving block defining javascript code
 * ex)
 ...
 */
var block_javascript_code = '';

/**
 * Variable for saving block generating javacript code
 * ex)
...
function updateLanguage() {
  ...
  /**
   * only needs javascript formatted code
   */
  var code = formatJavaScript_(blockType, rootBlock);
  block_javascript_code = code;
  console.log(block_javascript_code);
...
function saveBlock(){
  var xmlRequest;
  var params = 'block=' + block_javascript_code + '&generator=' + generator_javascript_code;
  ...
  xmlRequest.open("POST", '/project/', true);
