...
Blockly.JavaScript['voice_speak'] = function(block) {
    var value_hi = Blockly.JavaScript.valueToCode(block, 'HI', Blockly.JavaScript.ORDER_ATOMIC);
    // TODO: Assemble JavaScript into code variable.
    var code = "VoiceBind.sayText('" + value_hi + "');\n";
    return code;
};

Blockly.JavaScript['voice_input_contains'] = function(block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
    var code = "VoiceBind.findText(" + value_name + ");\n";
    return [code, Blockly.JavaScript.ORDER_NONE];
};

//Gesture type data (String)
Blockly.JavaScript['gesture_wave_in_text'] = function(block) {
    var code = "'WAVE_IN'";
    return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['gesture_wave_out_text'] = function(block) {
    var code = "'WAVE_OUT'";
    return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['gesture_fist_text'] = function(block) {
    var code = "'FIST'";
    return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['gesture_double_tap_text'] = function(block) {
    var code = "'DOUBLE_TAP'";
    return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['gesture_get'] = function(block) {
    var code = "GestureBind.getGesture()";
    return [code, Blockly.JavaScript.ORDER_NONE];
};
